...
<head>
    ...
    <style>
        ...
        #one:hover {
            background: #2A2F3C radial-gradient(circle, transparent 1%, #2A2F3C 1%) center/15000%;
            color: white;
        }
    ...
    <div style="background:#FDDC54;" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:green sm:items-center py-4 sm:pt-0">
        ...
        <div>
            ...
            <div class="relative flex  justify-center sm:items-center py-4 sm:pt-0">
                @auth
                <a id="one" href="{{ url('/dashboard') }}" style="
                         border-radius: 20px;
                        ...
                        ">Dashboard</a>
                @else
                <a id="one" href="{{ route('login') }}" style="
                        border-radius: 20px;
                        border: 5px solid #2A2F3C;
                        padding: 20px;
                        margin: 10px;
                ...
                <a id="two" href="{{ route('register') }}" style="
                        border-radius: 20px;
                        border: 5px solid #2A2F3C;
                        padding: 20px;
                        margin: 10px;
